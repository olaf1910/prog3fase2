...
const AppNavbar = () => {
      ...
      return (
        ...
        >
          ...
          <div className="px-3 py-2">
             <div className="fw-bold mb-1">{utilizadorAtual?.nome_utilizador}</div>
             <small className="text-muted d-block">Função: {funcaoUtilizador}</small>
          </div>
          <NavDropdown.Divider />
  ...
  return (
    <>
      <Navbar bg="light" className="mb-4 shadow-sm py-2" sticky="top">
        <Container fluid className="px-3">
          ...
          <Navbar.Brand as={RouterLink} to="/" className="fw-bold">FeedzzTrab</Navbar.Brand>
      ...
      <div className="container">
        <Routes>
          ...
          <Route
            path="/tarefas"
            element={
              <RotaProtegida adminBloqueado={true}>
                <PaginaTarefas />
              </RotaProtegida>
            }
          />
